...
-- Titlebars
theme.titlebar_bg_focus  = "#807665"
theme.titlebar_bg_normal = "#665C54"
...
theme.border_focus      = "#1d2021" --#1d2021
theme.border_normal     = "#1d2021" --#1d2021
